...
from equimed_dss.utils import plot_network_graph, plot_correlation_matrix
...
def main():
    ...
    plot_correlation_matrix(corr_res['correlation_matrix'], save_path="metric_correlation.png")
    print("Plot saved to metric_correlation.png")
    plot_network_graph(corr_res['graph'], title="Metric Correlation Network", save_path="metric_network.png")
    ...
    plot_network_graph(sim_res['graph'], title="Subgroup Similarity", save_path="subgroup_similarity.png")
    ...
    plot_network_graph(cooc_res['graph'], title="Concept Co-occurrence", save_path="concept_cooccurrence.png")
