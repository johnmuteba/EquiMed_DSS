...
from equimed_dss.domain2 import HarmAdjustedFairnessGap, HierarchicalEquityRatio
...
def main():
    ...
    errors = dataset.to_error_dicts(
        sensitive_col="race", group1="Black", group2="White"
    )
