import numpy as np
from equimed_dss.domain2 import HierarchicalEquityRatio, HarmAdjustedFairnessGap, EthicalRiskIndex, IntersectionalBiasScore
...
def main():
    ...
    plot_her_heatmap(plot_data, title="HER Heatmap (Synthetic Data)", save_path="her_heatmap.png")
    ...
    print(f"IBS Outlier: {ibs_results['outlier_subgroup']} (Dist: {ibs_results['outlier_distance']:.3f})")
