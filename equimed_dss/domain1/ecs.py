...
class EmbeddingConsistencyScore:
    ...
    def calculate_ecs(self, original_embeddings: np.ndarray, perturbed_embeddings: np.ndarray) -> Dict[str, float]:
        """
        ...
        for i in range(n_samples):
            ...
            if norm_orig == 0 or norm_pert == 0:
                ...
                cos_sim = np.dot(original_embeddings[i], perturbed_embeddings[i]) / (norm_orig * norm_pert)
