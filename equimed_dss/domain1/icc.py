...
class InterRaterReliability:
    ...
    def calculate_icc_2_1(self, judge_matrix: np.ndarray) -> Dict[str, Union[float, Dict]]:
        """
        ...
        denominator = ms_items + (n_judges - 1) * ms_error + (n_judges * (ms_judges - ms_error) / n_items)
    ...
    def bland_altman_analysis(self, judge_matrix: np.ndarray) -> Dict[str, Dict[str, float]]:
        """
